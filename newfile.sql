...
COMMENT ON COLUMN like_board.board_seq IS '게시글 번호';
COMMENT ON COLUMN like_board.kind IS '좋아요 0 싫어요 1';
COMMENT ON COLUMN like_board.in_date IS '작성일';
COMMENT ON COLUMN like_board.in_user_id IS '작성자';
COMMENT ON COLUMN like_board.up_date IS '수정일';
COMMENT ON COLUMN like_board.up_user_id IS '수정자';
COMMENT ON COLUMN like_reply.reply_seq IS '댓글 번호';
COMMENT ON COLUMN like_reply.kind IS '좋아요 0 싫어요 1';
COMMENT ON COLUMN like_reply.in_date IS '작성일';
COMMENT ON COLUMN like_reply.in_user_id IS '작성자';
COMMENT ON COLUMN like_reply.up_date IS '수정일';
COMMENT ON COLUMN like_reply.up_user_id IS '수정자';
...
COMMENT ON COLUMN reply.in_date IS '작성일';
COMMENT ON COLUMN reply.in_user_id IS '작성자';
COMMENT ON COLUMN reply.up_user_id IS '수정자';
COMMENT ON COLUMN reply.board_seq IS '게시글 번호';
COMMENT ON COLUMN reply.head_reply_seq IS '댓글 번호';
