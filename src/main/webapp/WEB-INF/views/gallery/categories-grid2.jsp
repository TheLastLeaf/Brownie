    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 p-0">
                ...
                <div class="row">
                    <div class="col-lg-12 card bg-secondary text-white text-center padding-top-10px padding-bottom-10px">
                        <div class="row">
                        ...
                        <hr/>
                        <div class="row">
                            <div class="col-1">[공지]</div>
                            <div class="col-6"><a class="lef" href="#"><strong>치타는 웃고있다. </strong></a></div>
                            <div class="col-1">곽지훈</div>
                            <div class="col-2">2014-01-28</div>
