        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="dg-slider owl-carousel">
                    <div class="dg-item set-bg" data-setbg="${pageContext.request.contextPath}/img/gallery/1.jpeg"></div>
                    <div class="dg-item set-bg" data-setbg="${pageContext.request.contextPath}/img/gallery/2.jpg"></div>
                    <div class="dg-item set-bg" data-setbg="${pageContext.request.contextPath}/img/gallery/3.jpg"></div>
                    <div class="dg-item set-bg" data-setbg="${pageContext.request.contextPath}/img/gallery/4.jpg"></div>
                    <div class="dg-item set-bg" data-setbg="${pageContext.request.contextPath}/img/gallery/5.gif"></div>
                    <div class="dg-item set-bg" data-setbg="${pageContext.request.contextPath}/img/gallery/6.jpg"></div>
                    <div class="dg-item set-bg" data-setbg="${pageContext.request.contextPath}/img/gallery/7.gif"></div>
                </div>
            </div>
        </div>
    </div>
