		...
		<div class="container">
			...
			<h3 style="color: white;">오늘의 붐업!</h3>
				<ul>
					<li>
						<p class="thmb">
							<a href="#"> <span>움짤</span> <div class="thumbnail"><img class="thumbnail" src="${path}/img/gallery/1.jpeg" alt=""></div>
							</a>
						</p> <a href="#"><strong>치타는 웃고있다.</strong></a>
					</li>
					<li>
						<p class="thmb">
							<a href="#"> <span>팬아트</span> <div class="thumbnail"><img class="thumbnail" src="${path}/img/gallery/2.jpg" alt=""></div>
							</a>
						</p> <a href="#"><strong>고양인 울고있다.</strong></a>
					</li>
					<li>
						<p class="thmb">
							<a href="#"> <span>팬아트</span> <div class="thumbnail"><img class="thumbnail" src="${path}/img/gallery/3.jpg" alt=""></div>
							</a>
						</p> <a href="#"><strong>강아진 짖고있다.</strong></a>
					</li>
					<li>
						<p class="thmb">
							<a href="#"> <span>습작</span> <div class="thumbnail"><img class="thumbnail" src="${path}/img/gallery/4.jpg" alt=""></div>
							</a>
			...
			<div class="sub_photo" style="height: 700px; width: 1150px; border: 3px solid white;">
				...
				<ul>
					...
					<li>
						<p class="thmb">
							<a href="#"> <span>팬아트</span> <img class="thumbnail" src="${path}/img/gallery/2.jpg" alt="">
							</a>
						</p> <a href="#"><strong>고양인 울고있다.</strong></a>
						<p class="tx_brief">2014-01-28</p>
					</li>
					<li>
						<p class="thmb">
							<a href="#"> <span>팬아트</span> <img class="thumbnail" src="${path}/img/gallery/3.jpg" alt="">
							</a>
						</p> <a href="#"><strong>강아진 짖고있다.</strong></a>
						<p class="tx_brief">2014-01-28</p>
					</li>
					<li>
						<p class="thmb">
							<a href="#"> <span>습작</span> <img class="thumbnail" src="${path}/img/gallery/4.jpg" alt="">
							</a>
						</p> <a href="#"><strong>강아진 물리고있다.</strong></a>
						<p class="tx_brief">2014-01-28</p>
					</li>
					<li>
						<p class="thmb">
							<a href="#"> <span>연재</span> <img class="thumbnail" src="${path}/img/gallery/5.gif" alt="">
							</a>
					...
					<li>
						<p class="thmb">
							<a href="#"> <span>연재</span> <imh class="thumbnail" src="${path}/img/gallery/6.jpg" alt="">
							</a>
					...
					<li>
						<p class="thmb">
							<a href="#"> <span>연재</span> <img class="thumbnail" src="${path}/img/gallery/7.gif" alt="">
							</a>
