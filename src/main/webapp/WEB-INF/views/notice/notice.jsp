...
<head>
    ...
    <style>
    	@font-face{
			...
			src:url("resource/asset/fonts/Maplestory Light.ttf")format("ttf");
			font-style:normal;
			font-weight:normal;
		}
    </style>
            ...
            <div class="container">
                ...
                <div class="nav-menu">
                    <ul>
                        ...
                        <span>팀원모집 <i class="fa fa-angle-down"></i></span></a>
                        ...
                        <li>
                            <a href="#"><span>팁&노하우 <i class="fa fa-angle-down"></i></span></a>
                            <ul class="dropdown">
                                <li><a href="./categories-list.html">Categories</a></li>
                                <li><a href="./categories-grid.html">Categories grid</a></li>
                                <li><a href="./typography.html">Typography</a></li>
                        ...
                        <li><a href="#"><span>자유게시판 <i class="fa fa-angle-down"></i></span></a></li>
                        <li><a href="#"><span>팬아트갤러리 <i class="fa fa-angle-down"></i></span></a></li>
<!--                         <li><a href="#"><span>Videos <i class="fa fa-angle-down"></i></span></a></li> -->
    ...
    <section class="hero-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="hs-text">
                        <div class="label"><span>PlayMode</span></div>
                        <h3>커뮤니티를 이용하고 승리하세요!<br>입이 심심하시다면 브라우니를 먹으세요!</h3>
                        <div class="ht-meta">
                            <img src="${path}/img/hero/mushrume.png" alt="">
                            <ul>
                                <li>by Dev.PSW</li>
                                <li>june 01, 2021</li>
                            </ul>
        ...
        <div class="hero-slider owl-carousel">
            ...
            <div class="hs-item set-bg" data-setbg="${path}/img/hero/lolDamwon.png"></div>
            <div class="hs-item set-bg" data-setbg="${path}/img/hero/lolPicture.jpg"></div>
<!--         </div> -->
    </section>
    <!-- Hero Section End -->
                        ...
                        <div class="row">
                            <div class="vg-slider owl-carousel">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="vg-item large-vg set-bg" data-setbg="${path}/img/videos/videos-1.jpg">
                                        ...
                                        <div class="col-md-6">
                                            <div class="vg-item large-vg set-bg" data-setbg="${path}/img/videos/videos-2.jpg">
                                                <a href="https://www.youtube.com/watch?v=EzKkl64rRbM"
                                                    class="play-btn video-popup"><i class="fa fa-play"></i></a>
                                                <div class="vg-text">
                                                    <h5>THROUGH THE AGES' FIRST EXPANSION WILL BE RELEASING ON DIGITAL
