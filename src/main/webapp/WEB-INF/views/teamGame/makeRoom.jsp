...
<div class="container">
	<div class="row">
		<div class="col text-center" style="border: 1px solid white;">
			...
			<div style="margin-bottom: 3px;" class="btn-group btn-group-toggle font-family-maple-light" data-toggle="buttons">
			...
			<div class="container">
				...
				<div style="margin-top: 10px; margin-bottom: 3px;">
					<label class="form-check-label font-family-maple-light" for="flexSwitchCheckChecked">인게임 마이크 사용</label>
				</div>
