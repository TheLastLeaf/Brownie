                    ...
                    <div class="dt-overall-rating">
                        ...
                        <div class="or-qualities">
                            <div class="qualities-item">
                                <p>The Goods</p>
                                <ul>
                                    <li><i class="fas fa-check"></i> Ut enim veniam, quis nostrud exercitation.</li>
                                    <li><i class="fas fa-check"></i> Irure dolor in reprehenderit in voluptate velit.
                                    </li>
                                    <li><i class="fas fa-check"></i> Excepteur sint occaecat cupidatat proident.</li>
                                    <li><i class="fas fa-check"></i> Sed ut perspiciatis unde omnis iste natus error.
                                    </li>
                                </ul>
                            </div>
                            <div class="qualities-item bad-item">
                                <p>The bads</p>
                                <ul>
                                    <li><i class=fas fa-times"></i> Ut enim veniam, quis nostrud exercitation.</li>
                                    <li><i class=fas fa-times"></i> Irure dolor in reprehenderit in voluptate velit.
                                    </li>
                                    <li><i class=fas fa-times"></i> Excepteur sint occaecat cupidatat proident.</li>
                                    <li><i class=fas fa-times"></i> Sed ut perspiciatis unde omnis iste natus error.
                                    </li>
                                </ul>
                            </div>
                        </div>
