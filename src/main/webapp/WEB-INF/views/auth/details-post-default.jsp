...
<section class="details-hero-section set-bg" data-setbg="${pageContext.request.contextPath}/img/details/details-post.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-8 p-0">
                <div class="details-text">
                    ...
                    <div class="dt-pic-item">
                        <div class="dp-pic">
                            <img src="${pageContext.request.contextPath}/img/details/dp-p.jpg" alt="">
                        </div>
                        <div class="dp-text">
