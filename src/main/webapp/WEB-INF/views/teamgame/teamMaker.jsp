				...
				<div class="details-text typography-page" style="width: 1050px; margin-left: -90px;">
					...
					<div class="dt-desc" style="display: block;">
						...
						<div class="row outBox" style="margin-left: 5px;">
							<!-- 방만들기 begin -->
							<div class="innerBox" style="text-align: center; display: flex; justify-content: center; align-items: center;">
								<label for="makeRoom" onclick="fn_makeRoom()">
									<img id="makeRoom" name="makeRoom" style="width: 40px; margin: 5px" src="${path}/img/details/plusButton.png">
									&nbsp; 방만들기
								</label>
							</div>
							<!-- 방만들기 end -->
