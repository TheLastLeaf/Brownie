    ...
    <div class="hw-menu mobile-menu">
        <ul>
            ...
            <li><a href="#">Pages <i class="fa fa-angle-down"></i></a>
                <ul class="dropdown">
                    <li><a href="${path}/categories-list">Categories</a></li>
                    <li><a href="${path}/categories-grid">Categories grid</a></li>
                    <li><a href="${path}/typography">Typography</a></li>
                    <li><a href="${path}/details-post-default">Post default</a></li>
                    <li><a href="${path}/details-post-gallery">Post gallery</a></li>
                    <li><a href="${path}/details-post-review">Post review</a></li>
...
<header class="header-section">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <a href="${path}/index"><img src="${path}/img/logo.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
    <div class="nav-options">
        <div class="container">
            ...
            <div class="nav-menu">
                <ul>
                    <li class="active"><a href="${path}/index"><span>Home</span></a></li>
