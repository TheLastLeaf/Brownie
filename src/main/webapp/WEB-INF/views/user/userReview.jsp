		...
		<div class="container">
			<form action="/user/userReview" class="signup-form" method="post" onsubmit="return fn_check()">
				...
				<div class="reviewUserInfo row">
					...
					<div class="reviewUser col-6">작성자: ${userVO.nickName}</div>
					<div class="reviewDate col-6">작성일: ${sysYear}</div>
				</div>
				<br />
				...
				<div class="comment sf-input-list">
					<input type="text" name="text" id="text" placeholder="수정이 안되오니 신중하게 작성해주세요!">
				</div>
