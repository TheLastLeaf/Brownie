                                    ...
                                    <div id="tierPic1">
                                        <c:choose>
                                            <c:when test="${userOneSelect.lolTier eq 'TBD'}">
                                                <img class="tierPic1"
                                                     src="${pageContext.request.contextPath}/img/details/LOL.png"/>
                                            </c:when>
                                            <c:when test="${userOneSelect.lolTier eq 'IRON'}">
                                                <img class="tierPic1"
                                                     src="${pageContext.request.contextPath}/img/lol/lolTier/iron.png"/>
                                            </c:when>
                                            <c:when test="${userOneSelect.lolTier eq 'BRONZE'}">
                                                <img class="tierPic1"
                                                     src="${pageContext.request.contextPath}/img/lol/lolTier/bronze.png"/>
                                            </c:when>
                                            <c:when test="${userOneSelect.lolTier eq 'SILVER'}">
                                                <img class="tierPic1"
                                                     src="${pageContext.request.contextPath}/img/lol/lolTier/silver.png"/>
                                            </c:when>
                                            <c:when test="${userOneSelect.lolTier eq 'GOLD'}">
                                                <img class="tierPic1"
                                                     src="${pageContext.request.contextPath}/img/lol/lolTier/gold.png"/>
                                            </c:when>
                                            <c:when test="${userOneSelect.lolTier eq 'PLATINUM'}">
                                                <img class="tierPic1"
                                                     src="${pageContext.request.contextPath}/img/lol/lolTier/platinum.png"/>
                                            </c:when>
                                            <c:when test="${userOneSelect.lolTier eq 'DIAMOND'}">
                                                <img class="tierPic1"
                                                     src="${pageContext.request.contextPath}/img/lol/lolTier/diamond.png"/>
                                            </c:when>
                                            <c:when test="${userOneSelect.lolTier eq 'MASTER'}">
                                                <img class="tierPic1"
                                                     src="${pageContext.request.contextPath}/img/lol/lolTier/master.png"/>
                                            </c:when>
                                            ...
                                            <c:when test="${userOneSelect.lolTier eq 'CHALLENGER'}">
                                                <img class="tierPic1"
                                                     src="${pageContext.request.contextPath}/img/lol/lolTier/challenger.png"/>
                                            </c:when>
                                            <c:otherwise>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <div style="position: absolute; top: 20px; left: 240px;">
                                        <button style="background: black; color: white; margin: 0px;"
                                                onclick="fn_SyncTierLv()" title="갱신하기">
                                            <i class="fas fa-sync-alt"></i>
                                        </button>
                                    </div>
                                    <div>
                                        | <span id="getLv">Lv. ${userOneSelect.lolLevel}</span> | <span
                                            id="getTier"> ${userOneSelect.lolTier} </span>
                                    </div>
                                </c:otherwise>
                            </c:choose>
                        </div>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <c:forEach items="${recentlyChatUserVOList}" var="recentlyChatUserVO">
                                        <div class="nickName">
                                            [<a class="col"
                                                href="/user/info/${recentlyChatUserVO.userId}">${recentlyChatUserVO.nickName}</a>]
                                        </div>
                                    </c:forEach>
                                </c:otherwise>
                            </c:choose>
                ...
                <div class="reputation row">
                    ...
                    <div class="col-sm-8" style="display: flex; justify-content: flex-end;">
                        <div class="searchBox">
                            ...
                            <input type="text" class="input-value" id="writeUser" name="keyword" style="display: block;"
                                   placeholder="작성자입력">
